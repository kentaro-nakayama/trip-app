      ...
      <DialogContent showCloseButton={false}>
        ...
        <div className="flex flex-col items-center gap-3 py-4">
          <button
            ...
            className="group relative h-24 w-24 shrink-0 overflow-hidden rounded-full border-2 border-dashed border-zinc-300 transition-colors hover:border-[rgb(76,71,205)]"
          >
