    ...
    >
      ...
      {shouldShow && (
        <div
          role="tooltip"
          className={cn(
            "absolute top-full z-40 mt-2 w-56 animate-in fade-in-0 zoom-in-95 rounded-xl bg-[rgb(76,71,205)] px-3 py-2.5 text-xs leading-relaxed text-white shadow-lg",
            align === "center" ? "left-1/2 -translate-x-1/2" : "right-0",
          )}
        >
          <div
            className={cn(
              "absolute -top-1.5 h-3 w-3 rotate-45 bg-[rgb(76,71,205)]",
